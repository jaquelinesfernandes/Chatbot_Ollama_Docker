...
st.set_page_config(page_title = "ChatBot com Ollama", page_icon = ":100:", layout = "centered")

# Título principal
st.title("🧪 Lab - Deploy de API Para Aplicação de IA com Ollama, Streamlit e Docker Compose")
...
if st.sidebar.button("Suporte"):
    st.sidebar.write("No caso de dúvidas envie e-mail para: jaqueline@jstech.dev.br")
